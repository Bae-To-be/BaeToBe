...
import 'package:baetobe/application/routing/auth_guard.dart' as _i29;
import 'package:baetobe/components/webview.dart' as _i27;
import 'package:baetobe/screens/boot/splash_screen.dart' as _i1;
import 'package:baetobe/screens/home/discover_tab.dart' as _i20;
import 'package:baetobe/screens/home/likes/likes_received_tab.dart' as _i24;
import 'package:baetobe/screens/home/likes/likes_sent_tab.dart' as _i25;
import 'package:baetobe/screens/home/likes_tab.dart' as _i21;
import 'package:baetobe/screens/home/matches_tab.dart' as _i22;
import 'package:baetobe/screens/home/profile_tab.dart' as _i23;
import 'package:baetobe/screens/homepage_screen.dart' as _i15;
...
import 'package:baetobe/screens/profile_screens/edit_profile_page.dart' as _i16;
import 'package:baetobe/screens/profile_screens/help_page.dart' as _i26;
import 'package:baetobe/screens/profile_screens/update_preferences_page.dart'
    as _i18;
import 'package:baetobe/screens/user_profile_screen.dart' as _i14;
...
import 'package:baetobe/screens/user_update/update_hometown.dart' as _i19;
...
class AppRouter extends _i17.RootStackRouter {
  ...
  final Map<String, _i17.PageFactory> pagesMap = {
    ...
    HomepageScreenRoute.name: (routeData) {
      return _i17.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i15.HomepageScreen());
    },
    ...
    UpdatePreferencesRoute.name: (routeData) {
      return _i17.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i18.UpdatePreferences());
    },
    UpdateHometownRoute.name: (routeData) {
      return _i17.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i19.UpdateHometown());
    },
    DiscoverTabRoute.name: (routeData) {
      return _i17.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i20.DiscoverTab());
    },
    LikesTabRoute.name: (routeData) {
      return _i17.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i21.LikesTab());
    },
    MatchesTabRoute.name: (routeData) {
      return _i17.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i22.MatchesTab());
    },
    ProfileTabRoute.name: (routeData) {
      return _i17.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i23.ProfileTab());
    },
    LikesReceivedTabRoute.name: (routeData) {
      return _i17.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i24.LikesReceivedTab());
    },
    LikesSentTabRoute.name: (routeData) {
      return _i17.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i25.LikesSentTab());
    },
    HelpPageRoute.name: (routeData) {
      final args = routeData.argsAs<HelpPageRouteArgs>(
          orElse: () => const HelpPageRouteArgs());
      return _i17.AdaptivePage<dynamic>(
          routeData: routeData, child: _i26.HelpPage(key: args.key));
    },
    WebviewRoute.name: (routeData) {
      ...
      return _i17.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i27.Webview(key: args.key, url: args.url));
    }
  };
  ...
  List<_i17.RouteConfig> get routes => [
        ...
        _i17.RouteConfig(SplashScreenRoute.name, path: '/splash'),
        _i17.RouteConfig(LoginScreenRoute.name, path: '/login'),
        _i17.RouteConfig(UpdateBirthdayScreenRoute.name,
            path: '/birthday', guards: [authGuard]),
        _i17.RouteConfig(UpdateGenderScreenRoute.name,
            path: '/gender', guards: [authGuard]),
        _i17.RouteConfig(UpdateInterestedGenderScreenRoute.name,
            path: '/interested_genders', guards: [authGuard]),
        _i17.RouteConfig(UpdateWorkInformationScreenRoute.name,
            path: '/work_details', guards: [authGuard]),
        _i17.RouteConfig(EducationHistoryScreenRoute.name,
            path: '/education_history', guards: [authGuard]),
        _i17.RouteConfig(LinkedinUrlScreenRoute.name,
            path: '/linkedin_url', guards: [authGuard]),
        _i17.RouteConfig(UploadImagesScreenRoute.name,
            path: '/images', guards: [authGuard]),
        _i17.RouteConfig(SelfieVerificationScreenRoute.name,
            path: '/selfie_verification', guards: [authGuard]),
        _i17.RouteConfig(IdentityVerificationScreenRoute.name,
            path: '/identity_verification', guards: [authGuard]),
        _i17.RouteConfig(UnderVerificationScreenRoute.name,
            path: '/under_verification', guards: [authGuard]),
        _i17.RouteConfig(VerificationRejectedScreenRoute.name,
            path: '/rejected', guards: [authGuard]),
        _i17.RouteConfig(UserProfileScreenRoute.name,
            path: '/profile_details/:id', guards: [authGuard]),
        _i17.RouteConfig(HomepageScreenRoute.name, path: '/home', guards: [
          authGuard
        ], children: [
          _i17.RouteConfig(DiscoverTabRoute.name,
              path: '', parent: HomepageScreenRoute.name),
          _i17.RouteConfig(LikesTabRoute.name,
              path: 'likes',
              parent: HomepageScreenRoute.name,
              children: [
                _i17.RouteConfig(LikesReceivedTabRoute.name,
                    path: '', parent: LikesTabRoute.name),
                _i17.RouteConfig(LikesSentTabRoute.name,
          ...
          _i17.RouteConfig(MatchesTabRoute.name,
              path: 'matches', parent: HomepageScreenRoute.name),
          _i17.RouteConfig(ProfileTabRoute.name,
        ...
        _i17.RouteConfig(EditProfileRoute.name,
            path: 'edit_profile', guards: [authGuard]),
        _i17.RouteConfig(EmptyRouterPageRoute.name, path: 'help', guards: [
          authGuard
        ], children: [
          _i17.RouteConfig(HelpPageRoute.name,
              path: '', parent: EmptyRouterPageRoute.name),
          _i17.RouteConfig(WebviewRoute.name,
              path: 'webview', parent: EmptyRouterPageRoute.name)
        ]),
        _i17.RouteConfig(UpdatePreferencesRoute.name,
            path: 'update_preferences', guards: [authGuard]),
        _i17.RouteConfig(UpdateHometownRoute.name,
...
class UpdateBirthdayScreenRoute
    extends _i17.PageRouteInfo<UpdateBirthdayScreenRouteArgs> {
  UpdateBirthdayScreenRoute({_i28.Key? key, bool? redirectBack})
...
class UpdateGenderScreenRoute
    extends _i17.PageRouteInfo<UpdateGenderScreenRouteArgs> {
  UpdateGenderScreenRoute({_i28.Key? key, bool? redirectBack})
...
class UpdateInterestedGenderScreenRoute
    extends _i17.PageRouteInfo<UpdateInterestedGenderScreenRouteArgs> {
  UpdateInterestedGenderScreenRoute({_i28.Key? key, bool? redirectBack})
...
class UpdateWorkInformationScreenRoute
    extends _i17.PageRouteInfo<UpdateWorkInformationScreenRouteArgs> {
  UpdateWorkInformationScreenRoute({_i28.Key? key, bool? redirectBack})
...
class EducationHistoryScreenRoute
    extends _i17.PageRouteInfo<EducationHistoryScreenRouteArgs> {
  EducationHistoryScreenRoute({_i28.Key? key, bool? redirectBack})
...
class LinkedinUrlScreenRoute
    extends _i17.PageRouteInfo<LinkedinUrlScreenRouteArgs> {
  LinkedinUrlScreenRoute({_i28.Key? key, bool? redirectBack})
...
class UploadImagesScreenRoute extends _i17.PageRouteInfo<void> {
...
class SelfieVerificationScreenRoute
    extends _i17.PageRouteInfo<SelfieVerificationScreenRouteArgs> {
  SelfieVerificationScreenRoute({_i28.Key? key, bool? redirectBack})
...
class IdentityVerificationScreenRoute
    extends _i17.PageRouteInfo<IdentityVerificationScreenRouteArgs> {
  IdentityVerificationScreenRoute({_i28.Key? key, bool? redirectBack})
...
class UnderVerificationScreenRoute extends _i17.PageRouteInfo<void> {
...
class VerificationRejectedScreenRoute extends _i17.PageRouteInfo<void> {
...
class UserProfileScreenRoute
    extends _i17.PageRouteInfo<UserProfileScreenRouteArgs> {
  UserProfileScreenRoute({_i28.Key? key, required int id})
...
/// generated route for
/// [_i15.HomepageScreen]
class HomepageScreenRoute extends _i17.PageRouteInfo<void> {
  const HomepageScreenRoute({List<_i17.PageRouteInfo>? children})
...
class EmptyRouterPageRoute extends _i17.PageRouteInfo<void> {
  const EmptyRouterPageRoute({List<_i17.PageRouteInfo>? children})
...
/// generated route for
/// [_i18.UpdatePreferences]
class UpdatePreferencesRoute extends _i17.PageRouteInfo<void> {
...
/// generated route for
/// [_i19.UpdateHometown]
class UpdateHometownRoute extends _i17.PageRouteInfo<void> {
...
/// generated route for
/// [_i20.DiscoverTab]
class DiscoverTabRoute extends _i17.PageRouteInfo<void> {
...
/// generated route for
/// [_i21.LikesTab]
class LikesTabRoute extends _i17.PageRouteInfo<void> {
  const LikesTabRoute({List<_i17.PageRouteInfo>? children})
...
/// generated route for
/// [_i22.MatchesTab]
class MatchesTabRoute extends _i17.PageRouteInfo<void> {
...
/// generated route for
/// [_i23.ProfileTab]
class ProfileTabRoute extends _i17.PageRouteInfo<void> {
...
/// generated route for
/// [_i24.LikesReceivedTab]
class LikesReceivedTabRoute extends _i17.PageRouteInfo<void> {
...
/// generated route for
/// [_i25.LikesSentTab]
class LikesSentTabRoute extends _i17.PageRouteInfo<void> {
...
/// generated route for
/// [_i26.HelpPage]
class HelpPageRoute extends _i17.PageRouteInfo<HelpPageRouteArgs> {
  HelpPageRoute({_i28.Key? key})
...
class WebviewRoute extends _i17.PageRouteInfo<WebviewRouteArgs> {
  WebviewRoute({_i28.Key? key, String? url})
