...
class _$ArticleTearOff {
  ...
  _Article call({required String title, required int id}) {
    return _Article(
      title: title,
      id: id,
    );
...
class _$_Article implements _Article {
  _$_Article({required this.title, required this.id});
...
abstract class _Article implements Article {
  factory _Article({required String title, required int id}) = _$_Article;
