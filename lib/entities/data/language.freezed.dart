...
class _$LanguageTearOff {
  ...
  _Language call({required String name, required int id}) {
    return _Language(
      name: name,
      id: id,
    );
...
class _$_Language implements _Language {
  _$_Language({required this.name, required this.id});
...
abstract class _Language implements Language {
  factory _Language({required String name, required int id}) = _$_Language;
