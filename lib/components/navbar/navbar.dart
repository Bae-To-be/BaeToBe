...
class CustomNavigationBar extends StatelessWidget {
  ...
  /// [CustomNavigationDestinationLabelBehavior.alwaysShow].
  // final CustomNavigationDestinationLabelBehavior? labelBehavior;
  ...
  Widget build(BuildContext context) {
    ...
    const CustomNavigationDestinationLabelBehavior effectiveLabelBehavior = CustomNavigationDestinationLabelBehavior.alwaysHide;
                  ...
                  Expanded(
                    child: _SelectableAnimatedBuilder(
                      ...
                      builder: (BuildContext context, Animation<double> animation) {
                        return _CustomNavigationDestinationInfo(
                          index: i,
...
/// Specifies when each [CustomNavigationDestination]'s label should appear.
///
/// This is used to determine the behavior of [NavigationBar]'s destinations.
enum CustomNavigationDestinationLabelBehavior {
...
class CustomNavigationDestination extends StatelessWidget {
  ...
  /// [CustomNavigationDestination] is selected.
  ///
  ...
  Widget build(BuildContext context) {
    ...
    final NavigationBarThemeData navigationBarTheme = NavigationBarTheme.of(context);
    final Animation<double> animation = _CustomNavigationDestinationInfo.of(context).selectedAnimation;

    return _CustomNavigationDestinationBuilder(
      label: label,
      tooltip: tooltip,
...
/// according to [_CustomNavigationDestinationInfo.selectedAnimation], where an
/// animation value of 0 is unselected and 1 is selected.
///
/// See [CustomNavigationDestination] for an example.
class _CustomNavigationDestinationBuilder extends StatelessWidget {
  /// Builds a destination (icon + label) to use in a Material 3 [NavigationBar].
  const _CustomNavigationDestinationBuilder({
    Key? key,
  ...
  /// [_CustomNavigationDestinationInfo.selectedAnimation]. When the animation is 0,
  ...
  ///
  /// To animate between unselected and selected, build the icon based on
  /// [_CustomNavigationDestinationInfo.selectedAnimation].  When the animation is
  ...
  @override
  Widget build(BuildContext context) {
    final _CustomNavigationDestinationInfo info = _CustomNavigationDestinationInfo.of(context);
...
/// `_CustomNavigationDestinationInfo.of(context)`.
class _CustomNavigationDestinationInfo extends InheritedWidget {
  /// Adds the information needed to build a navigation destination to the
  /// [child] and descendants.
  const _CustomNavigationDestinationInfo({
    Key? key,
    required this.index,
  ...
  /// NavigationBar(
  ///   destinations: [
  ///     CustomNavigationDestination(), // This is destination index 0.
  ///     CustomNavigationDestination(), // This is destination index 1.
  ///     CustomNavigationDestination(), // This is destination index 2.
  ///   ]
  /// )
  /// ```
  ///
  ...
  /// Returns a non null [_CustomNavigationDestinationInfo].
  ///
  /// This will return an error if called with no [_CustomNavigationDestinationInfo]
  /// ancestor.
  ///
  ...
  static _CustomNavigationDestinationInfo of(BuildContext context) {
    final _CustomNavigationDestinationInfo? result = context.dependOnInheritedWidgetOfExactType<_CustomNavigationDestinationInfo>();
    assert(
    result != null,
    'Navigation destinations need a _CustomNavigationDestinationInfo parent, '
  ...
  @override
  bool updateShouldNotify(_CustomNavigationDestinationInfo oldWidget) {
...
/// destination, based on [_CustomNavigationDestinationInfo.labelBehavior] and
/// [_CustomNavigationDestinationInfo.selectedAnimation].
///
/// Depending on the [_CustomNavigationDestinationInfo.labelBehavior], the labels
    ...
    return _DestinationLayoutAnimationBuilder(
      builder: (BuildContext context, Animation<double> animation) {
        return CustomMultiChildLayout(
          delegate: _CustomNavigationDestinationLayoutDelegate(
            animation: animation,
          ),
          children: <Widget>[
            LayoutId(
              id: _CustomNavigationDestinationLayoutDelegate.iconId,
            ...
            LayoutId(
              id: _CustomNavigationDestinationLayoutDelegate.labelId,
...
/// [_CustomNavigationDestinationInfo.labelBehavior].
///
/// The animation controlling the position and fade of the labels differs
/// from the selection animation, depending on the
/// [CustomNavigationDestinationLabelBehavior]. This widget determines what
...
class _DestinationLayoutAnimationBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (info.labelBehavior) {
      case CustomNavigationDestinationLabelBehavior.alwaysShow:
        return builder(context, kAlwaysCompleteAnimation);
      case CustomNavigationDestinationLabelBehavior.alwaysHide:
        return builder(context, kAlwaysDismissedAnimation);
      case CustomNavigationDestinationLabelBehavior.onlyShowSelected:
...
///
/// Requires a [_CustomNavigationDestinationInfo] parent (normally provided by the
/// [NavigationBar] by default).
///
/// Provides localized semantic labels to the destination, for example, it will
/// read "Home, Tab 1 of 3".
///
/// Used by [_CustomNavigationDestinationBuilder].
class _NavigationBarDestinationSemantics extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _CustomNavigationDestinationInfo destinationInfo = _CustomNavigationDestinationInfo.of(context);
...
/// [_CustomNavigationDestinationBuilder].
class _CustomNavigationDestinationLayoutDelegate extends MultiChildLayoutDelegate {
  _CustomNavigationDestinationLayoutDelegate({required this.animation}) : super(relayout: animation);

  /// The selection animation that indicates whether or not this destination is
  /// selected.
  ///
  /// See [_CustomNavigationDestinationInfo.selectedAnimation].
  final Animation<double> animation;
  ...
  ///
  /// See [_CustomNavigationDestinationBuilder].
  ...
  @override
  bool shouldRelayout(_CustomNavigationDestinationLayoutDelegate oldDelegate) {
